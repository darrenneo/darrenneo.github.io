...
function show(button_element) {
    ...
    */
    ...
    for (but of button) {
        but.style.backgroundColor = "darkblue";
        but.style.color = "white";
    }

    document.getElementById(button_element.id).style.color = "black";
    document.getElementById(button_element.id).style.backgroundColor = "aqua";
